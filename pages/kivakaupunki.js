            ...
            <span>
              <CaseStudyMeta
                ...
                fields={{
                  ...
                  conceptModel: "A map-based comment service that ties each comment to a location.",
                  keyDecisions: [
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          I handled the service, interaction, and UI framing: use case, pencil
                          drafts, Pixelmator mockups, screen flow, and heuristic evaluation. I also
                          worked on the HTML, React, and CSS layout, while the developer set up the
                          Heroku backend and CRUD API. The MVP and competition result were team
                          output.
                        </p>
                      }
                    />
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          The brief asked for something original, web-based, and useful to bus
                          passengers, but the real design challenge was turning scattered civic
                          comments into a clear task that people would actually finish.
                        </p>
                      }
                    />
                  </span>
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          Kiva Kaupunki collected user input tied to location and visualized it on a
                          map so residents, officials, and the public could read place-based
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          The project was condensed, so the work focused on a clear use case, a
                          lightweight flow, and a fast path from sketch to MVP.
                        </p>
                      }
                    />
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          The first question was what could realistically be built in the time
                          available. We browsed APIs on avoindata.fi looking for something related
                          to public transport, but the options were limited and Pasi had already
                    ...
                    <Row
                      content={
                        <p className={pStyle}>
                          We found an existing pattern worth adapting: services that let citizens
                          tag location-based comments so planning officials could see what residents
                          actually noticed about their city. That felt like the right fit for the
                          LLB audience, so I suggested we build our own version of it.
                        </p>
                      }
                    />
                  </span>
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          The design priority was clarity: what the user is doing right now, where
                          they are in the flow, and what comes next. I wrote a use case description
                          to work out which screens were actually needed, then sketched them quickly
                          in pencil with the focus on available interactions.
                        </p>
                      }
                    />
                    ...
                    <Row
                      content={
                        <div
                          ...
                          onClick={this.collapseEnvironment}
                        >
                          <Button
                            label={
                              this.state.environmentOpen
                                ? "Hide Use Case Description"
                    ...
                    <Collapse isOpened={this.state.environmentOpen}>
                      <Row content={<h4 className={pStyle}>USE CASE DESCRIPTION</h4>} />

                      <Row
                        content={
                          <p className={pStyle}>
                            A woman steps on a bus on her way to Hatanpää arboretum. She intends to
                            enjoy the sight of beautiful flowers and read a book by the lake. During
                            the bus ride, she sees a little girl crossing the road on a crossing.
                            The girl manages to cross the road but it looks like she feared high
                            traffic. Woman thinks that something should be done to make this
                            specific crossing safer as she also has felt unsafe crossing it on her
                            dog walks. Instead of passing on this thought she decides to do
                            something about it as there is now an easy way to act. She goes home
                            screen in her smartphone and touches the living lab buss icon, now she
                            selects Kiva Kaupunki from the main screen of the application. She
                            selects the crossing location on the app, selects the topic of
                            "Difficult to walk on foot" and goes on to write a comment about the
                            crossing. Application announces that the comment has been saved and will
                            be available soon on the map. The woman continues her journey to
                            location and decides to share also a comment on about arboretum on
                            arriving there, as it is one of her favorite places to visit.
                          </p>
                        }
                      />
                    </Collapse>

                    <Row content={<h4 className={pStyle}>User Interface Design</h4>} />

                    <Row
                      content={
                        <p className={pStyle}>
                          I moved the sketches into a higher-fidelity mockup in Pixelmator. Visual
                          style followed Material Design and the LLB color guidelines.
                        </p>
                      }
                    />
                    ...
                    {modalIsOpen ? (
                      <Modal isOpen={modalIsOpen} onRequestClose={this.toggleModal}>
                        ...
                        >
                          <div>
                            <img
                              src={resolveAssetSrc(phone)}
                              alt="Start greeting scene of app"
                              width={resolveAssetWidth(phone)}
                              height={resolveAssetHeight(phone)}
                              decoding="async"
                            />
                          ...
                          <div>
                            <img
                              src={resolveAssetSrc(phone_booth)}
                              alt="Location tagging by gps or by selecting and tapping."
                              width={resolveAssetWidth(phone_booth)}
                              height={resolveAssetHeight(phone_booth)}
                              loading="lazy"
                              decoding="async"
                            />
                            <p className="legend">
                              Location tagging by gps or by selecting and tapping.
                            </p>
                          </div>
                          <div>
                            <img
                              src={resolveAssetSrc(physical)}
                              alt="Second screen, notice the return button"
                              width={resolveAssetWidth(physical)}
                              height={resolveAssetHeight(physical)}
                              loading="lazy"
                              decoding="async"
                            />
                          ...
                          <div>
                            <img
                              src={resolveAssetSrc(popup)}
                              alt="Comment categories"
                              width={resolveAssetWidth(popup)}
                              height={resolveAssetHeight(popup)}
                              loading="lazy"
                              decoding="async"
                            />
                          ...
                          <div>
                            <img
                              src={resolveAssetSrc(watch)}
                              alt="Comment input"
                              width={resolveAssetWidth(watch)}
                              height={resolveAssetHeight(watch)}
                              loading="lazy"
                              decoding="async"
                            />
                          ...
                          <div>
                            <img
                              src={resolveAssetSrc(footsteps)}
                              alt="Final thank you screen"
                              width={resolveAssetWidth(footsteps)}
                              height={resolveAssetHeight(footsteps)}
                              loading="lazy"
                              decoding="async"
                            />
                        ...
                        return (
                          ...
                          >
                            <img
                              ...
                              alt=""
                              width={resolveAssetWidth(image)}
                              height={resolveAssetHeight(image)}
                              loading="lazy"
                              decoding="async"
                            />
                          </div>
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          The plan was to collect data of location, subject and a comment and make a
                          map data visualization when sufficient data has been collected and then
                          possibly pushing out an update for the users to inspect the map.
                        </p>
                      }
                    />
                    ...
                    <Row
                      content={
                        <p className={"caption " + pStyle}>
                          Pasi established Heroku backend with a very basic CRUD API, with POST
                          adding, GET getting all and id:GET getting a unique entry. It can be
                          confirmed here that the api has a location, topic and a comment.
                        </p>
                      }
                    />
                    ...
                    <Row
                      content={
                        <p className={pStyle}>
                          We built in React — Pasi's comfort zone. I handled the HTML layout and CSS
                          to match the mockup. With the deadline close, we worked through the
                          remaining issues together and submitted through the LLB Developer Portal.
                        </p>
                      }
                    />
                  </span>
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          I conducted heuristic usability analysis, based on Jakob Nielsen's 10
                          general principles for interaction design, to evaluate the MVP.
                        </p>
                      }
                    />
                    <Row
                      content={
                        <p className={pStyle}>
                          The review found a few practical strengths: the current state was visible
                          through headings and the top-right indicator, back navigation was
                          available, and the screens followed a consistent structure. It also made
                          the limits clear. Error messages, help, and documentation were missing, so
                ...
                content={
                  <span>
                    <Row
                      content={
                        <p className={pStyle}>
                          "With different pros and cons the jury found on multiple apps, the jury
                          chairman decided to divide the first prize between the three teams. Thus,
                          each team will receive 200 € and a diploma."
                        </p>
                      }
                    />
                    ...
                    <Row
                      content={
                        <p className={pStyle}>
                          The entry received part of the prize, but that is only proxy evidence. It
                          says the concept and prototype were credible in the competition setting,
                          not that the service was adopted or used by city officials.
                        </p>
                      }
                    />
                    ...
                    <Row
                      content={
                        <p className={pStyle}>
                          The more durable lesson was about ownership. The concept moved from use
                          case to interface to implementation support, but the compressed schedule
                          made coordination fragile. If I were doing the same work again, I would
                          define ownership and decision rhythm earlier instead of treating
                          scheduling as a side task.
                        </p>
                      }
                    />
                  </span>
                  ...
                  <Row
                    content={
                      <div className={pStyle + " links"} style={{ marginTop: "1.5em" }}>
                        <a href="https://github.com/paaplo/lblkk">
                          Github
                          <HighlightUnderline />
                        </a>
                        <div style={{ marginTop: "1.5em" }}>
                          <a href="http://www.pasikuparinen.fi/">
                            Pasi Kuparinen
                            <HighlightUnderline />
                          </a>
                        </div>
